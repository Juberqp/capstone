...
export default function Screen1({ navigation }) {
  ...
  const title = '이미지 질문';
  const text = '사진을 촬영하시면 알맞은 응답을 해드립니다.';
          ...
          <View style={styles.content}>
            <TouchableOpacity
              ...
              <Animated.View style={[styles.imagebox,{
                ...
                <Image source={require('../../data/icon/itt.png')} style={styles.image} />
              </Animated.View>
              <Text style={styles.title}>이미지 질문</Text>
              <Text style={styles.text}>사진을 촬영하시면</Text>
